...
import type {
  GetManagedStoresSalesListResponse,
  GetMoMSalesResponse,
...
export const salesControllerGetManagedStoresSalesList = (
    
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {
      
      
      return customInstance<GetManagedStoresSalesListResponse>(
      {url: `/sales/store`, method: 'GET', signal
    },
      options);
    }
...
export const getSalesControllerGetManagedStoresSalesListQueryKey = () => {
    return [
    `/sales/store`
    ] as const;
    }
...
export const getSalesControllerGetManagedStoresSalesListQueryOptions = <TData = Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getSalesControllerGetManagedStoresSalesListQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>> = ({ signal }) => salesControllerGetManagedStoresSalesList(requestOptions, signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type SalesControllerGetManagedStoresSalesListQueryResult = NonNullable<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>>
export type SalesControllerGetManagedStoresSalesListQueryError = unknown


export function useSalesControllerGetManagedStoresSalesList<TData = Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>,
          TError,
          Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>
        > , 'initialData'
      >, request?: SecondParameter<typeof customInstance>}
...
export function useSalesControllerGetManagedStoresSalesList<TData = Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useSalesControllerGetManagedStoresSalesList<TData = Awaited<ReturnType<typeof salesControllerGetManagedStoresSalesList>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getSalesControllerGetManagedStoresSalesListQueryOptions(options)
